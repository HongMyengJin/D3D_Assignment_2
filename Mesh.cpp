...
CMesh::~CMesh()
{
	if (m_pd3dIndexBuffer) m_pd3dIndexBuffer->Release(); // 추가
...
*/
void CTexturedRectMesh::Render(ID3D12GraphicsCommandList *pd3dCommandList, int nSubSet, int nPipelineState)
{
...
void CStandardMesh::Render(ID3D12GraphicsCommandList *pd3dCommandList, int nSubSet, int nPipelineState)
{
	pd3dCommandList->IASetPrimitiveTopology(m_d3dPrimitiveTopology);
...
void CHeightMapGridMesh::Render(ID3D12GraphicsCommandList* pd3dCommandList, int nSubSet, int nPipelineState)
{
	pd3dCommandList->IASetPrimitiveTopology(m_d3dPrimitiveTopology);
...
CSpriteMesh::CSpriteMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList) :CMesh(pd3dDevice, pd3dCommandList)
{
}
...
void CSpriteMesh::ReleaseUploadBuffers()
{
	if (m_pd3dVertexUploadBuffer) m_pd3dVertexUploadBuffer->Release();
	if (m_pd3dIndexUploadBuffer) m_pd3dIndexUploadBuffer->Release();
...
void CSpriteMesh::Render(ID3D12GraphicsCommandList* pd3dCommandList)
{
	pd3dCommandList->IASetPrimitiveTopology(m_d3dPrimitiveTopology);
